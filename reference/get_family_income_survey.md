...
Convenience wrapper for the Family Income and Expenditure Survey
(household income and spending, two-or-more-person households).
Equivalent to `get_estat_curated("family_income_survey", ...)`.

## Usage

``` r
get_family_income_survey(...)
```
